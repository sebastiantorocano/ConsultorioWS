 ...
 * @author GALEANO
 */
public class PrincipalOdontologo extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalOdontologo
     */
    public PrincipalOdontologo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnagenda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/agenda.png"))); // NOI18N
    ...
    private void btnagendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagendaActionPerformed
        // TODO add your handling code here:
        Agenda_Odontologo1 agenda = new Agenda_Odontologo1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalOdontologo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalOdontologo().setVisible(true);
            }
        });
    }
