...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2015 a las 15:26:38
...
CREATE TABLE IF NOT EXISTS `citas` (
  ...
  PRIMARY KEY (`id_cita`),
  KEY `citas_usuarios_FK` (`id_usuario_citas`)
...
('3002', '6/06/2015', '8', '15', 'prueba 2', 'prueba 2', '2524455', '', '1152205422', '', 'limpieza'),
('3003', '2/06/2015', '8', '15', 'prueba 3', 'prueba 3', '1122336', '', '1152205422', '', 'revision'),
('3004', '7/06/2015', '8', '00', 'Sebastian', 'Toro', '1234455', '', '1152205422', '', 'Revision'),
('3005', '9/08/2015', '9', '00', 'juan', 'pablo', '2222222', 'nada', '1152205422', '12345', 'limpieza'),
('3006', '10/08/2015', '8', '15', 'juan', 'pablo', '2222222', 'nada', '1152205422', '12345', 'limpieza'),
('3007', '19/08/2015', '8', '00', 'juan ', 'pablo', '2222222', 'nada', '1152205422', '12345', 'radiografia');
...
CREATE TABLE IF NOT EXISTS `citas_radiografias` (
  ...
  PRIMARY KEY (`id_cita_cr`,`id_radiografia_cr`),
  KEY `citas_rad_rad_FK` (`id_radiografia_cr`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `materiales_consultorio` (
  ...
  PRIMARY KEY (`id_matcon`),
  KEY `matcons_usuarios_FK` (`id_usuario_matcon`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `metbd_hc` (
  ...
  PRIMARY KEY (`id_metbd`,`num_doc_metbd`),
  KEY `metbd_hc_pacientes_FK` (`num_doc_metbd`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `odontograma_cita` (
  ...
  PRIMARY KEY (`id_cita_oc`,`id_odontograma_oc`),
  KEY `odont_cita_odont_FK` (`id_odontograma_oc`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  PRIMARY KEY (`numero_doc_paciente`),
  KEY `pacientes_estado_civil_FK` (`estado_civil_paciente`),
  KEY `pacientes_estados_FK` (`id_estado_paciente`),
  KEY `pacientes_genero_FK` (`genero_paciente`),
  KEY `pacientes_tipo_documento_FK` (`tipo_doc_paciente`),
  KEY `pacientes_usuarios_FK` (`cedula_usuario_paciente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `proveedores` (
  ...
  KEY `proveedores_usuarios_FK` (`id_usuario_proveedor`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `proveedor_materiales` (
  ...
  PRIMARY KEY (`id_proveedor_pm`,`id_mat_pm`),
  KEY `proveedor_mat_matcons_FK` (`id_mat_pm`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `seguimiento_hc` (
  ...
  PRIMARY KEY (`id_seg_hc`,`num_doc_seg`),
  KEY `seg_hc_pac_FK` (`num_doc_seg`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `tipos_relacion_molar_canina`
--

CREATE TABLE IF NOT EXISTS `tipos_relacion_molar_canina` (
  `id_tipo_rmc` varchar(10) NOT NULL,
  `num_doc_rmc` varchar(15) NOT NULL,
  `direccion_rmc` char(1) NOT NULL,
  `grado_direccion_rmc` varchar(3) NOT NULL,
  `linea_media_rcm` varchar(2) NOT NULL,
  PRIMARY KEY (`id_tipo_rmc`,`num_doc_rmc`),
  KEY `tipo_rel_mc_pac_FK` (`num_doc_rmc`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tipos_relacion_molar_canina`
--

INSERT INTO `tipos_relacion_molar_canina` (`id_tipo_rmc`, `num_doc_rmc`, `direccion_rmc`, `grado_direccion_rmc`, `linea_media_rcm`) VALUES
('20000', '1152205423', 'd', '3', '3'),
('24000', '1152205423', 'i', '1', '4');
...
--
-- Filtros para la tabla `tipos_relacion_molar_canina`
--
ALTER TABLE `tipos_relacion_molar_canina`
  ADD CONSTRAINT `tipo_rel_mc_pac_FK` FOREIGN KEY (`num_doc_rmc`) REFERENCES `pacientes` (`numero_doc_paciente`);
