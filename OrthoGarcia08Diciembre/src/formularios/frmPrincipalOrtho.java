 ...
 * @version 1
 */
public class frmPrincipalOrtho extends javax.swing.JFrame {

    /**
     * Creates new form frmPrincipalOrtho
     */
    public frmPrincipalOrtho() {
        initComponents();
        dpnEscritorio.setBorder(new ImagenFondo());
        this.setExtendedState(frmPrincipalOrtho.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        Mnucitas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/calendario.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(dpnEscritorio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 595, Short.MAX_VALUE)
        );
    ...
    private void MnucitasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MnucitasMouseClicked
        frmCitas misCitas = new frmCitas();

        dpnEscritorio.add(misCitas);
        misCitas.show(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPrincipalOrtho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPrincipalOrtho().setVisible(true);
            }
        });
    }
