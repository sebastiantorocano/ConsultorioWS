...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-08-2015 a las 21:03:07
...
CREATE TABLE IF NOT EXISTS `radiografias` (
  ...
  `url_radiografia` varchar(500) DEFAULT NULL,
  `id_radriografiaCef` varchar(50) DEFAULT NULL,
  `url_radiografiaCef` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `radiografias` (`id_radiografia`, `url_radiografia`, `id_radriografiaCef`, `url_radiografiaCef`) VALUES
('2009', 'C://Users//USUARIO//Desktop//OrthoGarcia10julio//src//Radiografias//cefalica_lateral.jpg', '2009', 'c:users'),
('28000', 'C://Users//USUARIO//Desktop//OrthoGarcia22julio//src//Radiografias//panoramica.jpg', '28000', 'C://Users//USUARIO//Desktop//OrthoGarcia22julio//src//Radiografias//cefalica_lateral.jpg');
...
--
-- Indices de la tabla `tipos_relacion_molar_canina`
--
ALTER TABLE `tipos_relacion_molar_canina`
 ADD PRIMARY KEY (`id_tipo_rmc`,`num_doc_rmc`), ADD KEY `tipo_rel_mc_pac_FK` (`num_doc_rmc`);
