...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2015 a las 00:51:39
...
('3010', '2015-09-21', '8', '00', 'sebastian', 'galeano', '5816895', '', 'juan felipe colon forero', '1152205422', '1152205426', 'limpieza');
...
CREATE TABLE IF NOT EXISTS `odontogramas` (
  ...
  `diente_18` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_17` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_16` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_15` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_14` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_13` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_12` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_11` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_55` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_54` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_53` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_52` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_51` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_21` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_22` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_23` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_24` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_25` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_26` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_27` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_28` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_61` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_62` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_63` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_64` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_65` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_85` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_84` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_83` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_82` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_81` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_48` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_47` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_46` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_45` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_44` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_43` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_42` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_41` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_71` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_72` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_73` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_74` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_75` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_31` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_32` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_33` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_34` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_35` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_36` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_37` varchar(10) NOT NULL DEFAULT '0000000000',
  `diente_38` varchar(10) NOT NULL DEFAULT '0000000000'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('12001', 'i', '0305021816', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000'),
('12002', 'e', '0000020000', '0000060000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000', '0000000000');
...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `motivo_consulta_paciente` text NOT NULL,
  `evol_est_actual_paciente` text,
  ...
  `otras_pat_antec_o_m` text,
  `observaciones_o_m` text,
  ...
  `observaciones_am` text,
  `diagnostico_esqueletico` text,
  `diagnostico_facial` text,
...
('1152205426', '1152205420', '2015-07-23', '34000', '32000', '29000', 'galeano', 'sebastian', '21', '1994-07-27', 'medellin', 'medellin', 'juan 23', '5816895', '3004915735', 'galesebas@gmail.com', 'sura', 'estudiante', '', '', 'Adriana bolivar', '71686517', '5816895', 'calle 48 dd # 99 58', '', 'Julian Galeano', 'calle 48 dd # 99 58', '5816895', 'revision', 'abcdefg', '', '10000', '142536', 's', 'n', 'n', 'n', 'n', 's', 'n', 'n', 's', 'n', 'n', 'n', 'n', 'n', 's', 'n', 'n', 'n', 'n', 'n', 'n', 'aaa', 'aaa', 'aaa', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 's', 'todo bien', 's', 's', 's', 's', 's', 's', 's', 'todo bien', '', '', '', '32', '', '', '', '32', 'n', '', 'n', '', 'n', '', 'bbbbb', 'CI.I', 'x', 'x', 'v', 'a', 's', 's', NULL, 's', 's', 'Temporal', 's', 's', 's', 's', 's', 's', 'i1', 'd1', '1', '1', '1', '1', 'ssasa', '1', '1', '1', '1', '1', 'abbb', 'aa', 'a', 'a', 'a', 'a', 'a', 'a', NULL, NULL, NULL, NULL, NULL);
...
('2000', 'familia', '3334455', 'calle 5410', '1213'),
...
('28010', 'Cefàlica lateral.', 'C://Users//USUARIO//Desktop//OrthoGarcia19agosto//src//Radiografias//perfil021.jpg', '12345');
...
CREATE TABLE IF NOT EXISTS `seguimiento_hc` (
  ...
  `evolucion_historia` text NOT NULL,
...
('37002', '1152205426', 'prueba 2', '2015-09-20');
...
INSERT INTO `usuarios` (`cedula_usuario`, `nombre_usuario`, `p_apellido_usuario`, `s_apellido_usuario`, `cargo_usuario`, `especialidad_usuario`, `contrasena`, `estado`) VALUES
('1152205420', 'juan felipe', 'colon', 'forero', 'Odontólogo', 'Endodoncia.', '123', '1'),
('1152205422', 'prueba auxiliar', 'prueba', 'prueba', 'Auxiliar', 'Seleccione una especialidad.', '123', '1'),
('1152216574', 'fabian', 'lopera', 'alvarez', 'Odontólogo', 'Ortodoncia.', '1020', '1'),
('1213', 'juan ', 'lopez', 'chaverra', 'Administrador', 'Seleccione una especialidad.', '011', '1');
